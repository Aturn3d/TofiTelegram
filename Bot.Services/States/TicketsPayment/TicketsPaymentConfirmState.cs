...
{
    internal class TicketsPaymentConfirmState : ConfirmStateBase
    {
        public TicketsPaymentConfirmState(TelegramBotService botService, Update update) : base(botService, update) {}
